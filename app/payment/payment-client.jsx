...
//   doc.text("REAL ESTATES OPPORTUNITY", 105, 25, { align: 'center' });
...
//   doc.setFontSize(10);
//   doc.setTextColor(100, 100, 100);
//   doc.text(`Receipt No: ${paymentData.transactionId}`, 20, 60);
//   doc.text(`Date: ${new Date().toLocaleDateString('en-IN')}`, 150, 60);
//   doc.text(`Time: ${new Date().toLocaleTimeString('en-IN', { hour: '2-digit', minute: '2-digit' })}`, 150, 65);
...
//   doc.setFontSize(12);
//   doc.setTextColor(0, 0, 0);
//   doc.text("PAYMENT AMOUNT", 105, 77, { align: 'center' });
  
//   doc.setFontSize(16);
//   doc.setTextColor(219, 7, 29);
//   doc.text(`₹${Number(paymentData.amountPaid).toLocaleString('en-IN')}`, 105, 85, { align: 'center' });
  
//   doc.setFontSize(10);
//   doc.setTextColor(100, 100, 100);
//   doc.text("Successfully Paid", 105, 90, { align: 'center' });
...
//       ],
//       theme: 'grid',
//       headStyles: { fillColor: [219, 7, 29], textColor: [255, 255, 255] },
//       styles: { fontSize: 9 },
//       columnStyles: {
...
//   const projectDetailsY = doc.lastAutoTable ? doc.lastAutoTable.finalY + 10 : 95;
  
//   autoTable(doc, {
//     startY: projectDetailsY,
...
//   const paymentDetailsY = doc.lastAutoTable.finalY + 10;
  
//   autoTable(doc, {
//     startY: paymentDetailsY,
//     head: [['PAYMENT TRANSACTION', 'DETAILS']],
//     body: [
...
//   // Financial Summary
//   if (fullBookingData?.total_property_value) {
//     const financialY = doc.lastAutoTable.finalY + 10;
    
//     const totalPaid = (Number(fullBookingData.token_advance || 0) + Number(paymentData.amountPaid || 0));
//     const remainingBalance = Number(fullBookingData.remaining_balance || 0) - Number(paymentData.amountPaid || 0);
    
//     // autoTable(doc, {
//     //   startY: financialY,
//     //   head: [['FINANCIAL SUMMARY', 'AMOUNT (₹)']],
//     //   body: [
//     //     ['Total Property Value', `₹${Number(fullBookingData.total_property_value || 0).toLocaleString('en-IN')}`],
//     //     ['Token Advance Paid', `₹${Number(fullBookingData.token_advance || 0).toLocaleString('en-IN')}`],
//     //     ['Amount Paid Now', `₹${Number(paymentData.amountPaid || 0).toLocaleString('en-IN')}`],
//     //     ['Total Paid Till Now', `₹${totalPaid.toLocaleString('en-IN')}`],
//     //     ['Remaining Balance', `₹${remainingBalance > 0 ? remainingBalance.toLocaleString('en-IN') : '0'}`],
//     //   ],
//     //   theme: 'grid',
...
//   doc.setFontSize(10);
//   doc.setTextColor(219, 7, 29);
//   doc.text("IMPORTANT NOTES:", 20, notesY);
...
//     doc.text(note, 20, notesY + 5 + (index * 4));
//   });
...
//   doc.text("Customer Signature", 160, footerY + 15);
  
//   doc.text(`Generated on: ${new Date().toLocaleString('en-IN')}`, 105, footerY + 25, { align: 'center' });
//   doc.text("© " + new Date().getFullYear() + " Real Estates Opportunity. All rights reserved.", 105, footerY + 30, { align: 'center' });
...
//           // Removed payment_date since it doesn't exist in your table
//           // If you need to store payment date, you can add a column in Supabase:
//           // 1. Go to Supabase dashboard
//           // 2. Go to Table Editor
//           // 3. Select 'bookings' table
//           // 4. Click 'Add column'
//           // 5. Add 'payment_date' column with type 'timestamptz'
//         })
//         .eq("id", bookingId);
...
//                           <span className="ml-2 font-medium">{bookingDetails.fullBookingData.full_name}</span>
//                         </div>
//                         {/* <div>
//                           <span className="text-gray-600">Project:</span>
//                           <span className="ml-2 font-medium">{bookingDetails.fullBookingData.project_name}</span>
//                         </div> */}
//                         <div>
//                           <span className="text-gray-600">Total Value:</span>
//                           <span className="ml-2 font-medium">₹{Number(bookingDetails.fullBookingData.total_property_value || 0).toLocaleString('en-IN')}</span>
//                         </div>
//                         <div>
//                           <span className="text-gray-600">Advance Paid:</span>
//                           <span className="ml-2 font-medium">₹{Number(bookingDetails.fullBookingData.token_advance || 0).toLocaleString('en-IN')}</span>
//                         </div>
//                       </div>
//                     </div>
//                   )}
